...
contract SettersTest is BaseTest {
    function testConstructorRoles() public view {
        ...
        assertTrue(roleManager.hasRole(roleManager.GOVERNANCE_ROLE(), governance));
        assertTrue(roleManager.hasRole(roleManager.GOVERNANCE_ROLE(), address(timelock)));
        assertTrue(roleManager.hasRole(roleManager.CURATOR_ROLE(), curator));
        assertTrue(roleManager.hasRole(roleManager.SENTINEL_ROLE(), sentinel));
        assertTrue(roleManager.hasRole(roleManager.ALLOCATOR_ROLE(), allocator));
    }
